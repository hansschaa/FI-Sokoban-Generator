...
# Agrupar por (shell_hash, num_boxes) -> esto aisla puramente el "move"
...
print(f"Puro 'move' (mismo shell, MISMA cantidad de cajas): media={np.mean(rhos_move):.3f}, n_grupos={len(rhos_move)}")
