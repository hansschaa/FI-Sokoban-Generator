...
def train_regressor(folds_to_run, restart=False):
    ...
    for fold in folds_to_run:
        train_path = os.path.join(RESULTS_DIR, f"regressor_v2_fold{fold}_train.pt")
        val_path   = os.path.join(RESULTS_DIR, f"regressor_v2_fold{fold}_val.pt")
        test_path  = os.path.join(RESULTS_DIR, f"regressor_v2_fold{fold}_test.pt")
        stats_path = os.path.join(RESULTS_DIR, f"regressor_v2_fold{fold}_stats.pt")
        ...
        ckpt_path = os.path.join(RESULTS_DIR, f"ckpt_regressor_v2_fold{fold}.pt")
        start_epoch = 1
        ...
        save_path = os.path.join(RESULTS_DIR, f"final_regressor_v2_fold{fold}.pt")
